...
import { newSessionSpawnSpec, sessionInstanceSpawnSpec, webServiceSpawnSpec } from "./spawn-spec.js";
...
describe("newSessionSpawnSpec（新建会话——--session-id 创建）", () => {
  it("argv：--session-id <新 id>；env 注册", () => {
